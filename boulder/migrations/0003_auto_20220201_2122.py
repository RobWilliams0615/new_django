# Generated by Django 4.0.2 on 2022-02-01 21:22

from django.db import migrations


def seed(apps, schema_editor):
    Fad = apps.get_model('boulder', 'Fad')
    Decade = apps.get_model('boulder', 'Decade')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('boulder', '0002_decade_fad_delete_dispensary'),
    ]
